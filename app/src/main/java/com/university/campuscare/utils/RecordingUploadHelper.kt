...
class RecordingUploadHelper(
    ...
    companion object {
        private val STORAGE_PATH get() = StringObfuscator.decrypt(ObfuscatedStrings.FIREBASE_RECORDINGS_PATH)
        private val COLLECTION get() = StringObfuscator.decrypt(ObfuscatedStrings.FIREBASE_RECORDINGS_PATH)
