    ...
    Scaffold(
        ...
        Box(
            ...
            when (selectedTab) {
                ...
                2 -> AlertsTab(userId)
                3 -> ProfileTab(userName, onLogout, onNavigateToSettings, onNavigateToHelpSupport, onNavigateToFacilitiesTeam, onNavigateToUserProfile, onNavigateToRemoteControl)
            }
        }
    }
}
